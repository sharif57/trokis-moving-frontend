...
export default function driver() {
  ...
  return (
    <div className="text-primaryText space-y-10">
          ...
          <div className="flex-1">
            <div className="space-y-6">
              {steps.map((step, index) => (
                <div
                  key={index}
                  className="flex flex-col border rounded-lg p-6 shadow-sm bg-white"
                >
                  <h3 className="text-lg md:text-xl font-normal text-primaryText">
      ...
      {/* testimonial section */}
      <div>
        <div className="flex flex-col items-center justify-start py-10 bg-[#f2f5f7] px-4">
      ...
      {/* get the most  */}
      <div className="lg:flex justify-between items-center mt-20 px-4">
        <div className="lg:w-[500px]    text-start">
          <h2 className="lg:text-4xl text-2xl font-normal text-primaryText  mb-4">
